...
# But scroll through the code to see how to progress - Maybe Ill add a number choice system 
...
# UPDATE - I have made a start on "The Way Of The Wizard" Text Adventure Game
